...
public interface SubscriptionTypeMapper {
    ...
    SubscriptionType toEntity(RequestSubscriptionTypeDTO dto);
    ...
    @Mapping(target = "updatedAt", ignore = true)
    @BeanMapping(nullValuePropertyMappingStrategy = NullValuePropertyMappingStrategy.IGNORE)
    void updateSubscriptionTypeFromDto(@MappingTarget SubscriptionType subscriptionType, RequestSubscriptionTypeDTO subscriptionTypeDTO);
