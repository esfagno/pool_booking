...
public class BookingRepositoryImpl implements BookingRepositoryCustom {
    ...
    public List<Booking> findBookingsByFilter(Booking filter) {
        return bookingCriteria.findBookingsByFilter(filter.getId(), filter.getStatus(), filter.getSession().getPool().getName(), filter.getSession().getStartTime());
    }
